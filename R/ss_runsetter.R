...
#' @param column The chosen column to study for differences in threshhold. Defaults to "Time," used by me to differentiate different measurements taken in the same file but separated by time.
#' @name ss_runsetter
#' @export
